...
import { 
  ...
  HomeIcon, DocumentTextIcon, UserIcon, LogOutIcon, SettingsIcon 
} from './Icons';
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto px-3 py-2">
          <div className="flex items-center justify-between px-2 mb-2">
            ...
            <span className="text-[10px] bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded-full">{conversations.length}</span>
          </div>
