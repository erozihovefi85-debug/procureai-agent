...
import { SparklesIcon, DocumentTextIcon, CheckIcon, GiftIcon, UserIcon } from './Icons';
 ...
 * Navbar Component
 */
const Navbar: React.FC<{ onShowToast: (msg: string) => void; onLoginRequest: () => void; user: User | null }> = ({ onShowToast, onLoginRequest, user }) => {
    return (
...
const HomeView: React.FC<HomeViewProps> = ({ onSelectMode, onLoginRequest, user }) => {
  ...
  return (
    <div className="relative h-screen bg-slate-50 overflow-y-scroll snap-y snap-mandatory scroll-smooth">
      ...
      <Navbar onShowToast={showToast} onLoginRequest={onLoginRequest} user={user} />
      ...
      <section className="relative min-h-screen flex flex-col snap-start">
          ...
          <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-6 text-center pt-28 pb-10">
              <div className="mb-12 animate-fadeIn">
                ...
                <p className="text-slate-500 text-lg md:text-xl font-light">智能采购 · 决策更简单 · 流程更合规</p>
              </div>
              ...
              <div className="w-full max-w-sm space-y-4 relative">
                ...
                >
                  ...
                  <span className="font-semibold text-lg">随心采购</span>
                </button>
                ...
                >
                  ...
                  <span className="font-semibold text-lg">规范采购</span>
                </button>
              </div>
                ...
                {selectedMode === 'casual' && (
                  <div className="text-left animate-fadeIn">
                    ...
                    <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                      轻松买买买，一站式节省研究时间。AI结合行业知识库和采购技巧，为您推荐最适合的商品，享受购物的乐趣。
                    </p>
                ...
                {selectedMode === 'standard' && (
                  <div className="text-left animate-fadeIn">
                    <h3 className="flex items-center gap-2 text-emerald-600 font-bold text-lg mb-3">
                       <DocumentTextIcon /> 规范采购模式
                    </h3>
                    <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                      专业采购，严谨流程。AI将协助您制定详细采购方案，生成专业文档，确保采购合规高效。
                    </p>
                    <ul className="space-y-2 text-slate-500 text-sm mb-6">
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-emerald-400"></span>制定详细采购方案</li>
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-emerald-400"></span>生成专业需求文档</li>
                    </ul>
                     <button 
